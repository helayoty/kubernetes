...
func (wrapper *PodGroupWrapper) MinCount(count int32) *PodGroupWrapper {
	wrapper.Policy.Kind = schedulingapi.PodGroupPolicyKindGang
...
// DefaultPolicy sets the PodGroup policy to Default.
func (wrapper *PodGroupWrapper) DefaultPolicy() *PodGroupWrapper {
	wrapper.Policy.Kind = schedulingapi.PodGroupPolicyKindDefault
	wrapper.Policy.Default = &schedulingapi.DefaultSchedulingPolicy{}
	return wrapper
}
